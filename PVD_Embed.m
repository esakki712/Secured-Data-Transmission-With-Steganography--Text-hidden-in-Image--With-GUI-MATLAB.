function PVD_Embed(file)
    I = imread(file);
    %trial = imread('PVD_baboon.png');
    %troll = imnoise(trial,'speckle',0.2);
    %imwrite(troll,'NoisedStego.png');
    %I = imread('NoisedStego.png');
    text_file = fopen('PVD_Embed.txt','r');
